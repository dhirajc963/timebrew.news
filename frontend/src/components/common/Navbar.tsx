	...
	return (
		<header className="fixed top-3 md:top-6 left-1/2 transform -translate-x-1/2 z-50 px-2 md:px-3 w-full max-w-7xl">
			...
			>
				...
				<div className="relative bg-card/90 backdrop-blur-2xl rounded-full border border-border/50 shadow-xl md:shadow-2xl shadow-black/20 px-4 py-3 md:px-8 md:py-4">
